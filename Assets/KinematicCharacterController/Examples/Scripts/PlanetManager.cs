...
namespace KinematicCharacterController.Examples
{
    public class PlanetManager : MonoBehaviour, IMoverController
    {
        ...
        public Teleporter OnPlaygroundStatemachineTeleportingZone;

        private List<ExampleCharacterController> _characterControllersOnPlanet = new List<ExampleCharacterController>();
        private List<PlayerMovementStateMachine> playerMovementStateMachinesOnPlanet = new List<PlayerMovementStateMachine>(); 
