...
{
    [CreateAssetMenu(menuName = "Finite State Machine/Player Movement/Decisions/Walk/Walk To Unarmed Sprint")]
    public class WalkToUnarmedSprintDecision : PlayerMovementStateDecision {
        ...
        public override bool Decide(PlayerMovementStateMachine machine) {
            ...
            if (machine.Inputs.SprintHold // holding sprint
                ...
                && machine.CurrentLocalVelocity.z > 0) // moving forward
                {
