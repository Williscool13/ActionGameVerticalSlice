...
public class PlayerAimController : MonoBehaviour
{
    ...
    const float crouchingCrouchHeight = -0.4f;
    ...
    void AimZoom() {
        follow.CameraDistance = Mathf.MoveTowards(follow.CameraDistance, AimingDownSights ? aimCameraDistance : baseCameraDistance, Time.deltaTime * aimZoomSpeed);
